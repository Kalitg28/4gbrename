...
class Database:
    ...
    def new_user(self, id):
        return dict(
            ...
            suffix=None,
            metadata=False,
            metadata_code=""" -map 0 -c:s copy -c:a copy -c:v copy -metadata title="Powered By:- @TamilRockerz_TR" -metadata author="@King_of_Kali" -metadata:s:s title="Subtitled By :- @TamilRockerz_TR" -metadata:s:a title="By :- @TamilRockerz_TR" -metadata:s:v title="By:- @TamilRockerz_TR" """
        )
